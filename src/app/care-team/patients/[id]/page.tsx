...
export default async function CareTeamPatientProfilePage({
  params,
}: {
  ...
  // 1. Fetch Care Team Provider orgId
  ...
  // 2. Fetch Patient details (must be in the same org)
  ...
  if (!patient || patient.orgId !== provider.orgId) {
  ...
  // 4. Fetch Messaging logs between care team and patient
