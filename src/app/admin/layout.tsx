...
import { Activity, LogOut, ChartBar } from 'lucide-react';
...
export default async function AdminLayout({
  ...
  const menuLinks = [
    { label: 'Admin Dashboard', href: '/admin/dashboard', type: 'ADMIN' as const },
  ];
      ...
      <aside className="hidden md:flex w-64 bg-slate-900 border-r border-slate-800 flex-col justify-between shrink-0">
        <div className="p-6">
          ...
          <div className="flex items-center gap-2 mb-8">
            ...
            <span className="font-bold text-lg text-white">VitalSync <span className="text-purple-400 text-xs font-semibold px-1 rounded bg-purple-950 border border-purple-800">SYS</span></span>
          </div>
          ...
          <nav className="space-y-1">
            <Link
              ...
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-purple-400 bg-slate-950 border border-purple-900/30"
            >
        ...
        <div className="p-6 border-t border-slate-800 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <span className="block text-xs text-slate-400 truncate">System Admin</span>
            </div>
          </div>
          ...
          <div className="text-[10px] text-slate-500 text-center pt-2">
            Healthcare system by <a href="https://www.medclinicx.com/" target="_blank" rel="noopener noreferrer" className="hover:text-slate-300 underline font-medium text-purple-550">Med Clinic X</a>
          </div>
        </div>
      </aside>
